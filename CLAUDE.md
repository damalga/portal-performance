...
- Astro 7.1.4, `@astrojs/preact` 6.0.1, Preact 10.29.7.
...
- CSS propio con variables. Sin Tailwind, sin librerías de UI.
...
- **Nunca colores fuera de `src/styles/tokens.css`**. Ningún hex ni rgb suelto en componentes. Todo se resuelve por variable CSS.
